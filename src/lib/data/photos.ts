...
export const CANONICAL_PHOTOS: PhotoArchiveItem[] = [
  {
    id: 'photo-1',
    title: 'Dawn Mist over Batasia Loop and Toy Train Steam',
    description: 'Vintage British B-class steam locomotive rounding the spiral curve of Batasia Loop with snow-capped Kanchenjunga in background.',
    photographer: 'Sujit Roy',
    district: 'Darjeeling',
  ...
  {
    id: 'photo-2',
    title: 'Terracotta Relief Plaques of Jor Bangla Temple',
    description: 'Exquisite 17th-century terracotta panels showing royal procession and archers at Bishnupur.',
  ...
  {
    id: 'photo-3',
    title: 'Angel of Victory over Victoria Memorial at Dusk',
    description: 'The rotating 16-foot bronze Angel of Victory perched atop the white Makrana marble dome reflected in the garden lake.',
    photographer: 'Tanmoy Sengupta',
    district: 'Kolkata',
  ...
  {
    id: 'photo-4',
    title: 'Chokkhu Daan at Kumartuli on Mahalaya Morning',
    description: 'Generational master artisan painting the divine third eye onto the clay idol of Goddess Durga.',
    photographer: 'Mousumi Ghoshal',
    district: 'Kolkata',
  ...
  {
    id: 'photo-5',
    title: 'Mystic Minstrel Singing Under Ancient Banyan in Kenduli',
    description: 'Baul singer in saffron robes strumming the ektara and singing verses of divine longing.',
    photographer: 'Prasanta Paul',
    district: 'Birbhum',
  ...
  {
    id: 'photo-6',
    title: 'Sundarbans Mangrove Creek at High Tide',
    description: 'Tidal creek deep inside the Sundarbans Biosphere Reserve fringed by Sundari tree stilt roots.',
    photographer: 'Debashis Mondal',
